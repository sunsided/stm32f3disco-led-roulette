...
\begin{tikzpicture}
    ...
    \begin{scope}[x={(\imagewidth cm,0)}, y={(0,\imageheight cm)}, z={(0cm,0cm,1cm)}, canvas is xy plane at z=0]
        ...
        \draw[line width=4mm, red, -stealth] (0.5, 0.55) -- (0.78, 0.9) node[right] {\LARGE \textbf X};
        \draw[line width=4mm, green, -stealth] (0.5, 0.55) -- (0.0, 0.7)node[left] {\LARGE \textbf Y};
        \draw[line width=4mm, blue, -stealth] (0.5, 0.55) -- (0.5, 0.1) node[below] {\LARGE \textbf Z};
    \end{scope}
\end{tikzpicture}
